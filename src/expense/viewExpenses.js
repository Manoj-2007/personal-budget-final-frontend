...
function ViewExpenses() {
    ...
    const handleDeleteExpense = async (expenseId) => {
        ...
        try {
            ...
            const response = await axios.delete(`http://167.99.61.114:4219/api/deleteExpense/${expenseId}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
                                ...
                                <div className="row form-group">
                                    <div className="col-md-12">
                                        <input
                                            type="submit"
                                            value="Submit"
                                            className="btn text-white px-4 py-2" style={{backgroundColor : 'green', color: 'white'}} variant={'secondary'}
                                        />
                                    </div>
                                </div>
